...
module.exports = {
  mysql: {
    database: env.SEQ_MYSQL_DB || env.SEQ_DB || 'soft_delete_triggers_test',
    username: env.SEQ_MYSQL_USER || env.SEQ_USER || 'soft_delete_triggers_test',
    password: env.SEQ_MYSQL_PW || env.SEQ_PW || 'soft_delete_triggers_test',
